...
const USER_ID = 'YOUR_USER_ID'; // Replace with your EmailJS User ID from the Integration page
const SERVICE_ID = 'YOUR_SERVICE_ID'; // Replace with your EmailJS Service ID (e.g., 'gmail_service')
...
export const sendVerificationEmail = async (email, fullName, verificationCode) => {
  try {
    ...
    const response = await send(SERVICE_ID, TEMPLATE_ID, templateParams, USER_ID);
