  ...
  export default function UploadModuleModal({ open, onClose, subject, onAccept }) {
    if (!open) return null;
    ...
    return (
      <div className="upload-module-overlay">
        <div className="upload-module-content">
          <h1 className="upload-module-title">Upload Module</h1>
          ...
          <div className="upload-module-subject-container">
            ...
            {/* <div className="upload-module-options">
              <span className="upload-module-option-text"></span>
              <span className="upload-module-or"></span>
              <span className="upload-module-option-text"></span>
            </div> */}
          </div>
